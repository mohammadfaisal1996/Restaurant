...
// where item_mapping.cat_id = $catid and category_items_list.category_list_type =1 and category_lang.language_code = 'en'
                                    ...
                                    while($row23= $stmt->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <div class="card-header card-header-warning">
                                   ...
                                   <form  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class=" form-group  mb-1">
                                            ...
                                            <label for="inputFloatingLabel" style ="color:black!important" class="placeholder">Edit  Name</label>
                                            <input    type="text" value="<?php echo $row23['category_title']?>"   name="item_title" class="form-control input-border-bottom" required="">                                   
                                        </div>
                                            
                                        <div class=" form-group  mb-1">
                                            <label for="inputFloatingLabel" style ="color:black!important" class="placeholder">Edit sub Name</label>
                                            <input    type="text" value="<?php echo $row23['category_subtitle']?>"   name="sub_item_title" class="form-control input-border-bottom" required="">                                   
                                        </div>

                                        <div class=" form-group  mb-1">

                                                <label for="inputFloatingLabel" style ="color:black!important" class="placeholder">Edit item price </label>
                                                <input    type="text" value="<?php echo $row23['item_price']?>"   name="item_price" class="form-control input-border-bottom" required="">   <span>JOD</span>                                
                                        </div>
                                          ...
                                          <div class=" form-group  mb-1">
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <img src="<?php echo $baseUrl->getBaseUrl().$row23['ImageName']?>" width='185' height='200' />
                                                                        </div>
                                                                        
                                                                                                    <?php 
                                                                
                                                                if($_SESSION['typeOFCat'] == 2){
                                                                ?>
                                                                <div class="col-sm-6">
                                                                            <h4>Item Sizes : </h4>
                                       ...
                                       <br><h3>Add Ons </h3><br>
                                            ...
                                            <button class="btn btn-primary" type="button" id="sendButton2">add</button>
                                                ...
                                                ?>
                                                    ...
                                                    <textarea   class="form-control"  rows="5"   name="Description"><?php  echo  $row23['Description'] ?></textarea>
                                        ...
                                        <div class=" form-group  mb-1">
                                        <button  id ="<?php echo $row23['category_id'] ?>" type="submit" name="updateData" class="btn btn-primary">Update</button>
                                        </div>
                ...
                if(isset($_POST['updateData'])){
                 ...
                 $extraID=$_POST['ExtraQuestionID'];
                  $optionSolve=$_POST['optionSolve'];
                    ...
                    if(isset($_POST['ItemSizeA'])&&isset($_POST['ItemPriceA'])&&!empty($_POST['ItemSizeA'])&&!empty($_POST['ItemPriceA'])){
                    ...
                    if(isset($_POST['item_title'])&&isset($_POST['item_price'])){
                            ...
                            if(isset($_POST['sub_item_title'])){
                                 $sub_item_title=$_POST['sub_item_title'];
                            }else{
                                 $sub_item_title=" ";
                            }
                    ...
                    $sql2 = "update category_items_list set  category_image ='".$Imagelink->name."',item_price=$item_price  where category_id=$catID and BranchesID=$branchID  ";
                    ...
                    if($stmt2->execute()){
                        ...
                        $sql3 = "update category_lang set  category_title ='$category_title',`category_subtitle`='$sub_item_title',`Ingredients`=:Description  where category_id=$catID";
