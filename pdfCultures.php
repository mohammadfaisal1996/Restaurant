...
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel123" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel123">Add  PDF  Data</h5>
      ...
      <div class="col-sm-12 col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="file"  class="form-group"  accept="image/png, image/gif, image/jpeg"  name='PDFImage' required id="myInput">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="table-responsive" id="order_table">
                      ...
                      <?php
                                            ...
                                            $sql = "SELECT * FROM `PDF` where type='CULTURES' ";
                                            $stmt = $db->prepare($sql);
                                            $stmt->execute();
                                            ...
                                            while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <td>
                                                <img src="<?php echo $row['PDF_Image']?>" width=100>
                                                </td>


                                                <td>
                                                  <textarea rows="4"  readonly cols="50"><?php echo $row['Description']?></textarea>
                                                </td>
...
// &&isset($_GET['Branchid'])&&isset($_FILES['file']) && isset($_POST['Description']) && isset($_FILES['PDFImage'])  
    if(isset($_POST['addPDF'])){
        ...
        $name= 'PDFImage';
        $path ="uploads/pdf/";
        $ImagePdf = new addImage($name,$path);



         if($ImagePdf->size < 524288){



        $sql2="INSERT INTO `PDF`(`type`, `file`, `PDF_Image`, `Description`, `status`, `BranchesID`) VALUES('CULTURES','".$Imagelink->getImageFullName()."','".$ImagePdf->getImageFullName()."','$Description',1, $Branchid)";
        ...
        if($stm2->execute()){
          ...
          ?>
          <script>location.replace("pdfCultures.php?Branchid=<?php echo $Branchid ?>");</script>
          <?php
        }
