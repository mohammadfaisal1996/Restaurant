...
<div class="main-panel">
          ...
          <div class="card-header card-header-warning">
            ...
            <br><h4 class="page-title" style="color:white">Add Category</h4><br>
            </div>
          ...
          <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input id="app_name"  type="text" name="sub_title_cat" class="form-control" >
                          </div>
                        </div>
                          <div class="col-md-3">
                          <div class="form-group">
                      ...
                      require 'aws/aws-autoloader.php';                       
                        if(isset($_POST["cat_add"]) && isset($_POST["title_cat"]) && isset($_POST["sub_title_cat"])&& isset($_FILES['file']) ) 
                        {
                          $catmain=$_GET['catidMain'];
                          $Branchid=$_GET['Branchid'];


                           echo "<h1 style='font-size:20px;color:red'>wow1</h1>";
                            $title = $_POST["title_cat"];
                            $sub = $_POST["sub_title_cat"];
                  
                            // $point = $_POST["point_cat"];
                              ...
                              `is_reward_category`,
                               ...
                               `related_item`,
                                ...
                                `points`,offer_price,BranchesID) VALUES (1,2,0,$catmain,'".$image->name."',0,0,0,0,0,$Branchid)";
                                    $stmt = $db->prepare($sql);
                                    if($stmt->execute()){
                                      echo "<h1 style='font-size:20px;color:red'>wow2</h1>";
                                    }
                            ...
                            if($stmt2->execute()){
                              header("location:Category.php?CATID=$catmain&Branchid=$Branchid");
                            }
